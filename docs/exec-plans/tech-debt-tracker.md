...
| --: | ------- | ---------- | ----------------------------------------------------------------------------- | ------------------------------ |
|   1 | JS      | 2026-03-13 | All application logic in single script.js — no modular separation             | feature/module-split           |
...
|   4 | Visual  | 2026-03-14 | FOUC on page load — default config briefly visible before user config renders | feature/test-and-debt-sweep    |
|   5 | Scripts | 2026-03-14 | Release scripts are PowerShell-only; incompatible with Linux dev environments | feature/test-and-debt-sweep    |
